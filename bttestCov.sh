#!/bin/tcsh
foreach cond (StudCor StudIncor Stud_nottested delayCor delayIncor faceCor faceIncor prevCor prevIncor)

3dttest++ -prefix /data6/olsen_lab/mayo/FuncConTTest/zFC_ttest28_${cond}_alltrials_cov \
-setA ${cond} \
